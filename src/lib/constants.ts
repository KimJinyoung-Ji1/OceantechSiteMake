export const SITE_CONFIG = {
  ...
  address: {
    main: '남양주시 다산순환로 20 현대프리미어캠퍼스 E동 7층 29호',
    office: '남양주시 다산순환로 20 현대프리미어캠퍼스 E동 7층 29호',
  ...
  patents: [
    {
      number: '10-2197917',
      titleKo: '친환경 어망추 제조기술',
      titleEn: 'Eco-friendly Fishing Net Weight Manufacturing',
      date: '2020.12.28',
      image: '/documents/certs/patent-2197917.png',
    },
    {
      number: '10-1801707',
      titleKo: '수중 장애물 자동 이탈 낚시추',
      titleEn: 'Auto-release Fishing Weight for Underwater Obstacles',
      date: '',
      image: null,
    },
    {
      number: '10-1801709',
      titleKo: '에어포켓 축광(야광) 부자',
      titleEn: 'Air-pocket Luminous Fishing Buoy',
      date: '',
      image: null,
    },
    {
      number: '10-2587572',
      titleKo: '친환경 문어잡이 낚시어구',
      titleEn: 'Eco-friendly Octopus Fishing Gear',
      date: '',
      image: null,
    },
    {
    ...
    },
    {
      number: '10-2640453',
      titleKo: '휴대용 구명백',
      titleEn: 'Portable Life-saving Bag',
      date: '',
      image: null,
    },
    {
      number: '10-2779255',
      titleKo: '친환경 봉돌 제조기술',
      titleEn: 'Eco-friendly Sinker Manufacturing',
      date: '',
      image: null,
    },
  ],
