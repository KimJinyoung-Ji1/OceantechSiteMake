  ...
  try {
    ...
    if (process.env.RESEND_API_KEY) {
      ...
      const phoneRow = phone
        ? `<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:16px 20px;font-weight:700;color:#475569;background:#f8fafc;">\uc804\ud654\ubc88\ud638</td><td style="padding:16px 20px;">${phone}</td></tr>`
        : '';
      ...
      const htmlContent = [
        ...
        '<div style="background:#9D174D;color:#fff;padding:28px 24px;border-radius:16px 16px 0 0;">',
        ...
        `<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:16px 20px;font-weight:700;color:#475569;width:110px;background:#f8fafc;">\uc774\ub984</td><td style="padding:16px 20px;">${name}</td></tr>`,
        `<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:16px 20px;font-weight:700;color:#475569;background:#f8fafc;">\uc774\uba54\uc77c</td><td style="padding:16px 20px;"><a href="mailto:${email}" style="color:#EC4899;">${email}</a></td></tr>`,
        phoneRow,
