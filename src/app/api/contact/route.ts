  ...
  try {
    ...
    if (process.env.RESEND_API_KEY && notifyEmail) {
      ...
      const htmlContent = [
        ...
        `<tr style="border-bottom:1px solid #e2e8f0;"><td style="padding:16px 20px;font-weight:700;color:#475569;background:#f8fafc;">\uc774\uba54\uc77c</td><td style="padding:16px 20px;"><a href="mailto:${email}" style="color:#0168EF;">${email}</a></td></tr>`,
        phoneRow,
