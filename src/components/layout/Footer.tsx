...
export default function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer
      ...
      aria-label="푸터"
    >
      <div className="mx-auto w-full max-w-[1360px] px-6 lg:px-10 py-16 lg:py-20">
        {/* 4-column grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <p className="text-xl font-black tracking-[0.1em]" style={{ color: '#7CB9FF' }}>
                  OCEANTECH
                </p>
            ...
            >
              <span className="h-2.5 w-2.5 rounded-full shrink-0" style={{ background: '#17E9B5' }} />
              <div>
          ...
          <div>
            ...
            <div className="mt-8 space-y-3">
              ...
              <div
                className="flex items-center gap-2 rounded-xl px-3 py-2.5"
                style={{
                  background: 'rgba(1,104,239,0.08)',
                  border: '1px solid rgba(1,104,239,0.2)',
                }}
              >
                <span className="h-2 w-2 rounded-full shrink-0" style={{ background: '#7CB9FF' }} />
                <div>
                  <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>
                    {locale === 'en' ? 'Venture Company' : '벤처기업'}
                  </p>
                  <p className="text-sm font-semibold" style={{ color: '#7CB9FF' }}>
