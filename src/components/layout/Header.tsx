  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="mx-auto flex h-14 lg:h-[72px] w-full max-w-[1600px] items-center justify-between px-4 lg:px-16">
            {/* Logo */}
        ...
        <AnimatePresence>
          {activeMenu ? (
            ...
            >
              <div className="mx-auto grid max-w-[1600px] grid-cols-[1.2fr_1.8fr] gap-8 px-16 py-8">
                <div
